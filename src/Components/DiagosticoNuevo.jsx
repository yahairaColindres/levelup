...
export default function DiagnosticoNuevo (props) {
    ...
    <div className='box1'>
      <Card>
        ...
        <CardMedia
          ...
          image='https://i.pinimg.com/1200x/38/5c/5a/385c5a05c7c2ac6cbb8d944a17df7698.jpg'
          title='FotoCliente'
        />
        ...
        <div className='box1'>
          <Box
            ...
            autoComplete='off'
          >
            <TextField label='EQUIPO' color='primary' focused style={{ width: '90%', marginBottom: '50px' }} />
            <TextField label='DIAGNOSTICO' color='primary' focused style={{ width: '90%', margin: '0 auto', marginBottom: '30px' }} />
            <div className='box2'>
              ...
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                ...
                >
                  <DemoItem label='Fecha Aproximada'>
                    <DatePicker
