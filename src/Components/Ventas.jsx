...
import VentaNuevo from './VentaNuevo'
...
export default function Equipos (props) {
  ...
  return (
    <div>
      <h1>VENTA</h1>
      <div>
        <Button size='large' onClick={handleOpen} variant='contained' color='primary'>EQUIPO EN VENTA </Button>
      </div>
      ...
      <div className='container'>
        {// manda los valores al card para extraer la información y mostrarla en pantalla // los parametros que se envian con el mapeo, se reciben en card como props
          ...
          info.map((inf, index) => (<CardVenta info={inf} />))
         }
      </div>
      ...
      <div>
        ...
        >
          <Box className='modalstyle'>
            <VentaNuevo handleClose={handleClose} />
          </Box>
        </Modal>
      </div>
