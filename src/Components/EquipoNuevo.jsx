...
import DiagnosticoNuevo from './DiagosticoNuevo'
    ...
    <div className='box1'>
      <Card>
        <Stack direction='row' spacing={2}>
          <Button size='large' color='error' onClick={clientClose}>X</Button>
        </Stack>
        <CardMedia
        ...
        <div className='box1'>
          <Box
            ...
            autoComplete='off'
          >
            <TextField label='NOMBRE CLIENTE' color='primary' focused style={{ width: '90%', marginBottom: '50px' }} />
            <TextField label='DESCRIPCIÓN' color='primary' focused style={{ width: '90%', margin: '0 auto', marginBottom: '30px' }} />
            <div className='box2'>
          ...
          <div>
            <Button size='large' variant='contained' onClick={handleOpen} color='primary'>Agregar Diagnóstico </Button>
          </div>
        </div>
      ...
      <div>
        ...
        >
          <Box className='modalstyle'>
            <DiagnosticoNuevo handleClose={handleClose} />
          </Box>
        </Modal>
      </div>
